...
; (function () {
    var ydj_purchasestockin = (function (_super) {
        var _child = function (args) {
            ...
            that.pageFile = '/views/ydj/ydj_purchasestockin.html';
            ...
            that.initOrderEntry = function (opData) {
                ...
                yiGrid.init(gridId, {
                    ...
                    colModel: [
                        ...
                        {
                            label: "数量", name: "famount", width: 80, editable: true, align: "left", fixed: true,
                            editrules: {
                        ...
                        {
                            label: "已出库数量", name: "fsaledamount", width: 80, editable: true, align: "left", fixed: true,
                            editrules: {
                                required: false, integer: true, minValue: -2147483648, maxValue: 2147483647
                            },
                            edittype: 'custom',
    ...
    window.ydj_purchasestockin = window.ydj_purchasestockin || ydj_purchasestockin;
})();