...
(function(root, factory) {
    ...
    message.load({ja: {
            Yes: "是", No: "否", Cancel: "取消", Clear: "清除", Done: "完成", Loading: "加载中…", Select: "选择…", Search: "搜索", Back: "返回", OK: "确定", "dxCollectionWidget-noDataText": "没有任何数据！", "validation-required": "必填项", "validation-required-formatted": "{0} 是必填的。", "validation-numeric": "数値を指定してください。", "validation-numeric-formatted": "{0} は数値でなければいけません。", "validation-range": "値が範囲外です", "validation-range-formatted": "{0} の長さが正しくありません。", "validation-stringLength": "値の長さが正しくありません。", "validation-stringLength-formatted": "{0} の長さが正しくありません", "validation-custom": "値が無効です。", "validation-custom-formatted": "{0} が無効です。", "validation-compare": "値が一致しません。", "validation-compare-formatted": " {0} が一致しません。", "validation-pattern": "値がパターンと一致しません", "validation-pattern-formatted": "{0} がパターンと一致しません", "validation-email": "電子メール アドレスが無効です。", "validation-email-formatted": "{0} が無効です。", "validation-mask": "値が無効です。"
        }})
}));
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
