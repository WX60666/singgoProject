...
define(function(require, exports, module) {
    ...
    var Menu = MenuBase.inherit({
        ...
        _moveFocus: function(location) {
            var argument, operation, navigationAction, $newTarget, $items = this._itemElements().filter(":visible"),
        ...
        _moveMainMenuFocus: function(direction) {
            var $newItem, $expandedItem = this.element().find("." + DX_MENU_ITEM_EXPANDED_CLASS).first(),
