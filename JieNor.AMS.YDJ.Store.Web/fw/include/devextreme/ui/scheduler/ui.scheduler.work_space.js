...
define(function(require, exports, module) {
    ...
    var SchedulerWorkSpace = Widget.inherit({
        ...
        _setTimePanelText: function(td, i) {
            td.innerHTML = this._getTimeText(i)
        },
        ...
        _setCellData: function(cell, rowIndex, cellIndex) {
            var data = this._prepareCellData(cell, rowIndex, cellIndex);
            $.data(cell, CELL_DATA, data)
        },
        ...
        _renderTableBody: function(options) {
            options.container.append(tableCreator.makeTable(options))
        },
        _cleanView: function() {
            this._cleanCellDataCache();
            this._$thead.empty();
