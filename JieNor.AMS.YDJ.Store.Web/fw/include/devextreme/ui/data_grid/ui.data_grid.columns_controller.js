        ...
        return {
            ...
            columnOption: function(identificator, option, value, notFireEvent) {
                var i, needUpdateIndexes, column, that = this,
                    ...
                    columns = identificator < 0 || "command" === identificatorOptionName ? that._commandColumns : that._columns;
                if (void 0 === identificator) {
                    return
                }
                ...
                for (i = 0; i < columns.length; i++) {
                    if (identificatorOptionName) {
                        ...
                        if (columns[i].index === identificator || columns[i].name === identificator || columns[i].dataField === identificator || columns[i].caption === identificator) {
                            column = columns[i];
                            break
                        }
                    }
            ...
            getRowCount: function(rowCount, bandColumnIndex) {
