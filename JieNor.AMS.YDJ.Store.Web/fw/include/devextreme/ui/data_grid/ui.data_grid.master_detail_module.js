                ...
                data: function() {
                    ...
                    return {
                        ...
                        _changeRowExpandCore: function(key) {
                            var expandIndex, rowIndex, detailIndex, that = this;
                            if (commonUtils.isArray(key)) {
                                return that.callBase.apply(that, arguments)
                            } else {
                                expandIndex = gridCoreUtils.getIndexByKey(key, that._expandedItems);
                                ...
                                detailIndex = that._getDetailIndex(rowIndex);
                                that.updateItems({
                                    changeType: "update",
                                    rowIndices: [rowIndex, detailIndex]
                                })
                            }
                        },
                        _getDetailIndex: function(rowIndex) {
                            return rowIndex + 1
                        },
