            ...
            views: {
                rowsView: {
                    _getCellTemplate: function(options) {
                        ...
                        if ("adaptive" === column.command && "groupFooter" !== options.rowType) {
                    ...
                    getCellElement: function(rowIndex, columnIdentificator) {
                        ...
                        if (item && item.rowType === DATAGRID_ADAPTIVE_ROW_TYPE) {
                            return this._adaptiveColumnsController.getItemContentByColumnIndex(columnIdentificator)
                        } else {
                            return this.callBase(rowIndex, columnIdentificator)
                        }
                    },
            ...
            controllers: {
                ...
                editing: {
                    _getFormEditItemTemplate: function(cellOptions, column) {
                        if (this.getEditMode() !== DATAGRID_EDIT_MODE_ROW && cellOptions.rowType === DATAGRID_ADAPTIVE_ROW_TYPE) {
                ...
                data: {
                    _getDetailIndex: function() {
                        var items = this.items(),
                            detailIndex = this.callBase.apply(this, arguments);
                        if (items[detailIndex] && items[detailIndex].rowType === DATAGRID_ADAPTIVE_ROW_TYPE) {
                            detailIndex++
                        }
                        return detailIndex
                    },
