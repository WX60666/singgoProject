            ...
            setColumnWidths: function(widths) {
                ...
                if ("virtual" === this.option("scrolling.mode")) {
                    ...
                    if (this.getScrollable()) {
                        selector = "> ." + DATAGRID_SCROLLABLE_CONTAINER + " > ." + DATAGRID_SCROLLABLE_CONTENT + selector
                    }
                    this.callBase(widths, this.element().find(selector).children(":not(." + DATAGRID_TABLE_CONTENT_CLASS + ")"))
                }
            },
            dispose: function() {
