(function (a) {
    a.alerts = {
        ...
        _overReposition: function () {
            var c = 4;
            c = ((a(window).height() / 2) - (a("#over_container").outerHeight() / 2)) + a.alerts.verticalOffset;
        ...
        _show: function (j, b, k, g, m, l, c, f, n) {
            ...
            a("body").append('<div id="popup_container" style="display:none"><div id="popup_title">&nbsp;</div><div id="popup_content"><div id="popup_message"></div></div></div>');
            if (a.alerts.dialogClass) {
            ...
            switch (g) {
                case "alert":
                    a("#popup_message").after('<div id="popup_panel"><input type="button" class="easyui-linkbutton easyui-linkbutton-yellow" value="' + a.alerts.okButton + '" id="popup_ok" /></div>');
                    ...
                    switch (j) {
                        case 0:
                            break;
                        case 1:
                            a("#popup_content").removeClass(g).addClass("warning");
                            break;
                        case 2:
                            a("#popup_content").removeClass(g).addClass("error");
                            break;
                        default:
                            break;
                    }
                    break;
                case "confirm":
                    a("#popup_message").after('<div id="popup_panel"><input class="easyui-linkbutton easyui-linkbutton-yellow" type="button" value="' + a.alerts.yesButton + '" id="popup_ok" /> <input class="easyui-linkbutton m-btn-s" type="button" value="' + a.alerts.noButton + '" id="popup_cancel" /></div>');
                    a("#popup_ok").click(function () {
                        a.alerts._hide();
                        if (m) {
                            m(true)
